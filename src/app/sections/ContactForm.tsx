...
function ContactForm() {
  ...
  const handleSubmit = (e) => {
    ...
    // Email addresses
    const recipients = "eva@themarketingtribe.co,charu@themarketingtribe.co";
    
    // Constructing the mailto link
    const mailtoLink = `mailto:${recipients}?subject=Contact%20Form%20Submission&body=
      Name: ${encodeURIComponent(formData.name)}%0D%0A
      Email: ${encodeURIComponent(formData.email)}%0D%0A
      Company Website: ${encodeURIComponent(formData.website)}%0D%0A
      Mobile Number: ${encodeURIComponent(formData.mobile)}%0D%0A
  ...
  return (
    <div id="contactUs" className="py-10 md:py-20">
      <Container>
        <div className="text-[#F7A400] font-semibold capitalize mb-2">
          LET&apos;S COLLABORATE!
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="bg-white p-6 md:p-10 rounded-2xl shadow-lg border">
            <div className="text-[#180D51] font-medium text-lg mb-4">
              Reach out and let&apos;s shape the future of your business together.
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="url" name="website" value={formData.website} onChange={handleChange} className="mt-1 block w-full p-2 bg-[#F9F8FF] rounded-xl" placeholder="Enter company website" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">
              ...
              <button type="submit" className="bg-[#180D51] text-white px-6 py-2 rounded-xl font-semibold hover:bg-[#180D52]">
